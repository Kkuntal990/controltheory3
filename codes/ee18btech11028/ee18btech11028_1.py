...
H_s=signal.ZerosPolesGain(zeros,poles,1) # feed zeros and poles as inputs to this function to get w,H=signal.freqresp(H_s,w=omega)#feed H_s and omega values as inputs to this funtion it will return frequency response H of H_s and w the range of omega values of H
